...
export function RagTab({ bindings }: Props) {
  ...
  return (
    <motion.div custom={0} variants={cardVariants} initial="hidden" animate="visible">
      <Card
        title={formatMessage({ id: "settings.rag.operatingModes" })}
        style={{ ...settingsCardStyle, marginBottom: 16 }}
      >
        <div style={{ color: "var(--color-text-secondary)", lineHeight: 1.6 }}>
          {formatMessage({ id: "settings.rag.operatingModesDescription" })}
        </div>
      </Card>
      ...
      <Collapse
        items={[
          {
            key: "expert-rag",
            label: formatMessage({ id: "settings.rag.expertConfiguration" }),
            children: (
              <>
                <Card
                ...
                >
                  <div style={twoColGrid}>
                    <Form.Item
                      name={["rag", "chunk_size_tokens"]}
                      label={formatMessage({ id: "settings.rag.chunkSize" })}
                      rules={[{ required: true }]}
                    >
                      <InputNumber min={64} max={4096} step={32} style={{ width: "100%" }} />
                    </Form.Item>
                    <Form.Item
                      name={["rag", "chunk_overlap_tokens"]}
                      label={formatMessage({ id: "settings.rag.chunkOverlap" })}
                      rules={[{ required: true }]}
                    >
                      <InputNumber min={0} max={1024} step={16} style={{ width: "100%" }} />
                    </Form.Item>
                  </div>
                      ...
                      getFieldValue(["rag", "hybrid_search_enabled"]) ? (
                        ...
                        >
                          <InputNumber
                            ...
                            step={0.1}
                            style={{ width: "100%" }}
                            placeholder="0 = pure BM25, 1 = pure vector"
                          />
                        </Form.Item>
                      ) : null
                    }
                        ...
                        >
                          {({ getFieldValue }) => {
                            ...
                            if (val === "multimodal" || val === "hybrid_multimodal") {
                              return (
                                <Tooltip
                                  title={formatMessage({ id: "settings.reindexRequiredHint" })}
                                >
                  ...
                  items={[
                    {
                      ...
                      children: (
                        <>
                          ...
                          <Divider
                            style={{ borderColor: "var(--color-border)", margin: "12px 0" }}
                          />
                          <Form.Item
                                  ...
                                  >
                                    <Input
                                      placeholder={formatMessage({
                                        id: "settings.placeholder.sameAsLlm",
                                      })}
                                    />
                                  </Form.Item>
                                </div>
                                ...
                                <>
                                  <div style={twoColGrid}>
                                    <Form.Item
                                      ...
                                      label={formatMessage({
                                        id: "settings.rag.boundaryThreshold",
                                      })}
                                    >
                                      <InputNumber
                                        min={0}
